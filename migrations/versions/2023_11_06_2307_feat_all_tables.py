...
Revision ID: 68517282820d
Revises: 
Create Date: 2023-11-06 23:07:05.021842
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "status_id",
            sa.Enum(
                "RECALL", "PENDING", "APPROVED", "REJECTED", name="adstatus"
            ),
            nullable=False,
        ),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["chat_id"], ["chat.chat.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
        schema="chat",
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["member_id"], ["chat.chat_member.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
        schema="chat",
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["user_uuid"], ["user.user.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
        schema="subscription",
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["message_id"], ["chat.message.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
        schema="chat",
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["status_id"],
            ["response.response_status.id"],
        ),
        sa.ForeignKeyConstraint(
            ["team_uuid"], ["team.team.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
        schema="response",
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["response_id"], ["response.ad_response.id"], ondelete="CASCADE"
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["skill_id"], ["skill.skill.id"], ondelete="CASCADE"
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["contact_id"], ["user.contact_type.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(["cv_id"], ["user.cv.id"], ondelete="CASCADE"),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["permission_id"], ["team.team_permission.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["role_id"], ["team.team_role.id"], ondelete="CASCADE"
        ),
